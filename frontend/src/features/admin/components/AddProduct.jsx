...
export const AddProduct = () => {
  ...
  useEffect(() => {
    if (productAddStatus === "fulfilled") {
      reset();  // Reset form upon successful product addition
  ...
  useEffect(() => {
    return () => {
      dispatch(resetProductAddStatus());  // Clear status when component unmounts
    };
  }, [dispatch]);
  ...
  const handleAddProduct = (data) => {
    ...
    dispatch(addProductAsync(newProduct));  // Dispatch action to add product
  };
